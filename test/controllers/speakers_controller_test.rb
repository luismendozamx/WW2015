...
class SpeakersControllerTest < ActionController::TestCase
  ...
  test "should create speaker" do
    assert_difference('Speaker.count') do
      post :create, speaker: { bio: @speaker.bio, first_name: @speaker.first_name, last_name: @speaker.last_name }
    end
  ...
  test "should update speaker" do
    patch :update, id: @speaker, speaker: { bio: @speaker.bio, first_name: @speaker.first_name, last_name: @speaker.last_name }
    assert_redirected_to speaker_path(assigns(:speaker))
  end
