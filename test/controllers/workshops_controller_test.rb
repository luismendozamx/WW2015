...
class WorkshopsControllerTest < ActionController::TestCase
  ...
  test "should create workshop" do
    assert_difference('Workshop.count') do
      post :create, workshop: { description: @workshop.description, slug: @workshop.slug, title: @workshop.title }
    end
  ...
  test "should update workshop" do
    patch :update, id: @workshop, workshop: { description: @workshop.description, slug: @workshop.slug, title: @workshop.title }
    assert_redirected_to workshop_path(assigns(:workshop))
  end
