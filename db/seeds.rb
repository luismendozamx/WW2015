...
Workshop.create(title: "PASTEL DE LA A A LA Z", speaker_id: 22, category_id: 2, day_id: 1, time: "18:00 - 20:00", slot: 2, description: "Sonia nos dará un demostración de todo lo que comprende crear un pastel delicioso y original. ")
...
Workshop.create(title: "NUTRICÓN CONSCIENTE / RECETAS FÁCILES Y PRÁCTICAS", speaker_id: 23, category_id: 2, day_id: 2, time: "09:00 - 11:00", slot: 4, description: "Un taller para cambiar hábitos, saber qué comer, con recetas deliciosas y facilísimas de hacer de @thewholetable.")
...
Workshop.create(title: "MI RETO ANTE LA OBESIDAD INFANTIL", speaker_id: 26, category_id: 2, day_id: 3, time: "12:30 - 14:00", slot: 12, description: "Si te interesa darle la mejor nutrición a tus hijos y te preocupa el problema de la mala nutrición (sobrepeso y obesidad) que pueden tener, en esta plática encontrarás tips, sugerencias, recomendaciones que te ayudaran en este gran reto.")
...
Workshop.create(title: "NUTRICIÓN EMOCIONAL Y VITALIDAD FÍSICA", speaker_id: 28, category_id: 4, day_id: 2, time: "18:00 - 20:00", slot: 14, description: "En este Taller obtendrás consejos, tips y recetas para lograr un mayor equilibrio y sentirte saludable en todos los aspectos de tu vida.")
...
Workshop.create(title: "COCINA VEGANA SIN GLUTEN", speaker_id: 29, category_id: 2, day_id: 2, time: "11:00 - 12:00", slot: 11, description: "En este Taller obtendrás consejos, tips y recetas para lograr un mayor equilibrio y sentirte saludable en todos los aspectos de tu vida.")
...
Workshop.create(title: "POLE THERAPY", speaker_id: 31, category_id: 3, day_id: 2, time: "12:00 - 14:00", slot: 6, description: "Los beneficios físicos y terapéuticos de esta disciplina son excepcionales. No se trata sólo de hacer acrobacias y ganar fuerza, sino de la conexión que se logra con tu feminidad y con tu mujer sensual interna.")
...
Workshop.create(title: "BODY METHOD", speaker_id: 32, category_id: 3, day_id: 2, time: "10:00 - 12:00", slot: 5, description: "Se compone de una serie de entrenamientos dinámicos diseñados para activar el metabolismo, quemar grasa, esculpir el cuerpo, limpiar los órganos, adquirir flexibilidad y fuerza.")
...
Workshop.create(title: "YOGA PARA DESPERTAR TU POTENCIAL", speaker_id: 33, category_id: 3, day_id: 2, time: "08:00 - 10:00", slot: 4, description: "En este taller, Dakini nos llevará de la mano en una secuencia de posturas para poder conectar con nuestro ser y nuestro potencial femenino.")
...
Workshop.create(title: "BACHATA: SENSUALIDAD LATINA", speaker_id: 35, category_id: 3, day_id: 2, time: "17:00 - 18:30", slot: 9, description: "En este taller, Mar nos introduce en el mundo de la bachata. Desde su origen y pasos básicos, encontrando así una divertida forma de expresar la sensualidad.")

Speaker.create(first_name: "MAR", last_name: "VARGAS", category_id: 3, description: "BAILARINA DE RITMOS LATINOS", bio: "Con más de 7 años de experiencia en la danza y la docencia, Mariana ha notado que a través del baile la mujer latina redescubre la pasión que llevan dentro, por medio del movimiento y la conciencia corporal, comprobando así, que las mujeres latinas aparte de profesionistas, también son sensuales.")
Workshop.create(title: "BACHATA: SENSUALIDAD LATINA", speaker_id: 35, category_id: 3, day_id: 2, time: "17:00 - 18:30", slot: 9, description: "En este taller, Mar nos introduce en el mundo de la bachata. Desde su origen y pasos básicos, encontrando así una divertida forma de expresar la sensualidad.")

Speaker.create(first_name: "MARLENE", last_name: "CARBONELL", category_id: 7)
Workshop.create(title: "LADY SALSA", speaker_id: 36, category_id: 3, day_id: 1, time: "16:00 - 17:00", slot: 1)

Speaker.create(first_name: "MARIBEL", last_name: "SANABRIA", category_id: 7)
Workshop.create(title: "BUDOKON: BALANCE BODY & SOUL", speaker_id: 37, category_id: 3, day_id: 1, time: "19:00 - 20:00", slot: 3)
