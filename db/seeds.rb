...
Workshop.create(title: "BODY METHOD", speaker_id: 32, category_id: 3, day_id: 2, length: 2, time: "10:00 - 12:00", slot: 5, description: "Se compone de una serie de entrenamientos dinamicos diseñados para activar el metabolismo, quemar grasa, esculpir el cuerpo, limpiar los organos, adquirir flexibilidad y fuerza.")
...
Workshop.create(title: "LA FOTOGRAFIA Y SUS MEJORES REPRESENTANTES", speaker_id: 63, category_id: 6, day_id: 2, length: 3, time: "15:30 - 17:00", slot: 13, description: "En este taller Ana nos hablará de su experiencia como fotógrafa y nos compartirá algunos tips y bases de fotografía.")

Speaker.create(first_name: "MAYRA", last_name: "CONTRERAS", category_id: 7)
Workshop.create(title: "NEGOCIOS Y MUJER, COMO GANAR LA VITRINA DIGITAL", speaker_id: 64, category_id: 6, day_id: 1, length: 1, time: "16:00 - 17:00", slot: 1)
