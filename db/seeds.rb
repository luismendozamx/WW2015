...
Event.create(location_id: 1, limit: 120, limit_banamex: 30, speaker_id: 2, day_id: 1, time: "17:00 - 18:00", slot: 2, name: "EFECTO DETOX", description: "En esta conferencia, Dominika nos hablará de la importancia de una alimentación sana, alcalina y libre de toxinas.")
...
Event.create(location_id: 1, limit: 120, limit_banamex: 30, speaker_id: 3, day_id: 2, time: "18:00 - 19:00", slot: 14, name: "RETOS DE LA MUJER LABORAL", description: "En esta conferencia, Olivia nos compartirá su experiencia de como la sociedad la percibe a la mujer laboral.")
...
Event.create(location_id: 1, limit: 120, limit_banamex: 30, speaker_id: 4, day_id: 2, time: "19:00 - 20:00", slot: 15, name: "ENCUENTRA LA BELLEZA QUE HAY EN TI", description: "Hildelisa nos dará tips de belleza y nos hablará sobre varios puntos que puedes identificar en ti para lucir tu potencial.")
...
Event.create(location_id: 1, limit: 120, limit_banamex: 30, speaker_id: 16, day_id: 1, time: "19:00 - 20:00", slot: 4, name: "DESARROLLANDO TALENTOS", description: "En esta plática Lizzy nos hablará sobre su experiencia en el mundo artístico y como se desarrolla al artista para poder llegar al éxito.")
...
Event.create(location_id: 1, limit: 120, limit_banamex: 30, speaker_id: 17, day_id: 2, time: "10:00 - 11:00", slot: 6, name: "CÓMO EMPRENDER Y NO MORIR EN EL INTENTO", description: "En este panel Ana Victoria nos presentará a algunas de las emprendedoras de V147, quienes compartirán sus experiencias y claves de éxito.")

#TBD
Speaker.create(first_name: "TBD", last_name: "", category_id: 7)
Event.create(location_id: 1, limit: 120, limit_banamex: 30, speaker_id: 18, day_id: 2, time: "09:00 - 10:00", slot: 5, name: "TBD")
Event.create(location_id: 1, limit: 120, limit_banamex: 30, speaker_id: 18, day_id: 2, time: "13:00 - 14:00", slot: 9, name: "TBD")
Event.create(location_id: 1, limit: 120, limit_banamex: 30, speaker_id: 18, day_id: 2, time: "15:00 - 16:00", slot: 11, name: "LUNCH")

Speaker.create(first_name: "NATALIA", last_name: "LÓPEZ", category_id: 1)
Event.create(location_id: 1, limit: 120, limit_banamex: 30, speaker_id: 19, day_id: 2, time: "14:00 - 15:00", slot: 10, name: "LOS VALORES DE LA MUJER MEXICANA")

Speaker.create(first_name: "ABASEH", last_name: "MIRVALI", category_id: 1)
Event.create(location_id: 1, limit: 120, limit_banamex: 30, speaker_id: 20, day_id: 3, time: "12:00 - 13:00", slot: 19, name: "PANEL DE CULTURA")
...
Event.create(location_id: 1, limit: 120, limit_banamex: 30, speaker_id: 21, day_id: 3, time: "13:00 - 14:00", slot: 20, name: "PANEL DE GASTRONOMÍA", subtitle: "EL PAPEL DE LA MUJER EN LA COCINA CONTEMPORÁNEA")

#Workshops

# Cooking
Workshop.create(location_id: 3, limit: 25, limit_banamex: 5, title: "TBD", speaker_id: 18, category_id: 2, day_id: 1, length: 2, time: "16:00 - 18:00", slot: 2, description: "Sonia nos dará un demostración de todo lo que comprende crear un pastel delicioso y original. ")
...
Workshop.create(location_id: 3, limit: 25, limit_banamex: 5, title: "PASTEL DE LA A A LA Z", speaker_id: 22, category_id: 2, day_id: 1, length: 2, time: "18:00 - 20:00", slot: 2, description: "Sonia nos dará un demostración de todo lo que comprende crear un pastel delicioso y original. ")
...
Workshop.create(location_id: 3, limit: 25, limit_banamex: 5, title: "NUTRICÓN CONSCIENTE / RECETAS FÁCILES Y PRÁCTICAS", speaker_id: 23, category_id: 2, day_id: 2, length: 2, time: "09:00 - 11:00", slot: 4, description: "Un taller para cambiar hábitos, saber qué comer, con recetas deliciosas y facilísimas de hacer de @thewholetable.")
...
Workshop.create(location_id: 3, limit: 25, limit_banamex: 5, title: "MI RETO ANTE LA OBESIDAD INFANTIL", speaker_id: 26, category_id: 2, day_id: 3, length: 3, time: "12:30 - 14:00", slot: 12, description: "Si te interesa darle la mejor nutrición a tus hijos y te preocupa el problema de la mala nutrición (sobrepeso y obesidad) que pueden tener, en esta plática encontrarás tips, sugerencias, recomendaciones que te ayudaran en este gran reto.")
...
Workshop.create(location_id: 4, limit: 20, limit_banamex: 5, title: "NUTRICIÓN EMOCIONAL Y VITALIDAD FÍSICA", speaker_id: 28, category_id: 4, day_id: 3, length: 2, time: "11:30 - 13:00", slot: 14, description: "En este Taller obtendrás consejos, tips y recetas para lograr un mayor equilibrio y sentirte saludable en todos los aspectos de tu vida.")
...
Workshop.create(location_id: 3, limit: 25, limit_banamex: 5, title: "COCINA VEGANA SIN GLUTEN", speaker_id: 29, category_id: 2, day_id: 3, length: 3, time: "11:00 - 12:00", slot: 11, description: "En este Taller obtendrás consejos, tips y recetas para lograr un mayor equilibrio y sentirte saludable en todos los aspectos de tu vida.")
...
Workshop.create(location_id: 2, limit: 25, limit_banamex: 5, title: "POLE THERAPY", speaker_id: 31, category_id: 3, day_id: 2, length: 2, time: "12:00 - 14:00", slot: 6, description: "Los beneficios físicos y terapéuticos de esta disciplina son excepcionales. No se trata sólo de hacer acrobacias y ganar fuerza, sino de la conexión que se logra con tu feminidad y con tu mujer sensual interna.")
...
Workshop.create(location_id: 2, limit: 25, limit_banamex: 5, title: "YOGA PARA DESPERTAR TU POTENCIAL", speaker_id: 33, category_id: 3, day_id: 2, length: 2, time: "08:00 - 10:00", slot: 4, description: "En este taller, Dakini nos llevará de la mano en una secuencia de posturas para poder conectar con nuestro ser y nuestro potencial femenino.")
...
Workshop.create(location_id: 2, limit: 25, limit_banamex: 5, title: "BUDOKON: BALANCE BODY & SOUL", speaker_id: 38, category_id: 3, day_id: 1, length: 3, time: "18:30 - 20:00", slot: 3)

Speaker.create(first_name: "ADRIANA", last_name: "DÁVILA", category_id: 7)
Workshop.create(location_id: 2, limit: 25, limit_banamex: 5, title: "BALLET BABY", speaker_id: 39, category_id: 3, day_id: 2, length: 1, time: "16:00 - 17:00", slot: 8)
Workshop.create(location_id: 2, limit: 25, limit_banamex: 5, title: "SPINNING EN LA OSCURIDAD", speaker_id: 39, category_id: 3, day_id: 2, length: 3, time: "18:30 - 20:00", slot: 10)
...
Workshop.create(location_id: 4, limit: 20, limit_banamex: 5, title: "COMO MEJORAR LA PIEL A BASE DE LA ALIMENTACIÓN.", speaker_id: 41, category_id: 4, day_id: 3, length: 1, time: "13:00 - 14:00", slot: 15, description: "El dermatólogo de las artistas, platicará y sobre como una alimentación balanceada, alcalina y basada en vegetales crudos, es el principal fundamento de un cutis sano y vibrante. ¡Confía, sus típs harán que tu piel cambie!")
...
Workshop.create(location_id: 4, limit: 20, limit_banamex: 5, title: "POWER YOUR STYLE", speaker_id: 43, category_id: 4, day_id: 1, length: 3, time: "18:30 - 20:00", slot: 3, description: "Una plática que habla sobre inseguridades, mujeres, estilo personal, de como aceptarte y amar tu imagen. Cómo puedes empoderarte a través de la moda y el estilo personal.")
...
Workshop.create(location_id: 4, limit: 20, limit_banamex: 5, title: "CUSTOMIZA TU ROPA", speaker_id: 44, category_id: 4, day_id: 1, length: 3, time: "16:00 - 17:30", slot: 1, description: "En este taller aprenderás a sacarle provecho a algunas prendas que ya no usas y que estabas planeando regalar.")
...
Workshop.create(location_id: 4, limit: 20, limit_banamex: 5, title: "EL TECHO DE CRISTAL, A TRAVÉS DE LA VIDA", speaker_id: 47, category_id: 4, day_id: 1, length: 1, time: "17:30 - 18:30", slot: 2, description: "Hablará del reto de la mujer de hoy en el ámbito empresarial. Cuál es el rol de la mujer de hoy, a qué se enfrenta, qué ha cambiado y cómo preparase para cumplir los retos personales y profesionales.")

Workshop.create(location_id: 4, limit: 20, limit_banamex: 5, title: "ATELLIER LANCOME: EL ARTE DE LUCIR BELLA A LA FRANCESA", speaker_id: 18, category_id: 4, day_id: 2, length: 2, time: "09:00 - 11:00", slot: 5)
Workshop.create(location_id: 4, limit: 20, limit_banamex: 5, title: "ATELLIER LANCOME: EL ARTE DE LUCIR BELLA A LA FRANCESA", speaker_id: 18, category_id: 4, day_id: 3, length: 2, time: "10:00 - 11:30", slot: 13)

Speaker.create(first_name: "ALEJANDRA URBINA Y", last_name: "ANDREA BRACHO", category_id: 7)
Workshop.create(location_id: 4, limit: 20, limit_banamex: 5, title: "RECREANDO, DECORA TU CASA RECICLANDO", speaker_id: 48, category_id: 4, day_id: 2, length: 2, time: "11:00 - 13:00", slot: 6)

Speaker.create(first_name: "NANCY", last_name: "RODRIGUEZ", category_id: 7)
Workshop.create(location_id: 4, limit: 20, limit_banamex: 5, title: "JOYERÍA", speaker_id: 49, category_id: 4, day_id: 2, length: 3, time: "17:00 - 18:30", slot: 10)
...
Workshop.create(location_id: 2, limit: 25, limit_banamex: 5, title: "SOUL YOGA", speaker_id: 50, category_id: 3, day_id: 3, length: 2, time: "09:00 - 11:00", slot: 12, description: "Es un estilo de yoga creado por Alex. Cada sesión es temática, enfocada a un aspecto que inspire a mente, cuerpo y energía a trascender hacia el alma.")

# Cooking
Speaker.create(first_name: "LETICIA", last_name: "SAENZ", category_id: 7)
Workshop.create(location_id: 3, limit: 25, limit_banamex: 5, title: "EL MUNDO DEL TÉ", speaker_id: 51, category_id: 2, day_id: 2, length: 3, time: "11:00 - 12:30", slot: 5)

Workshop.create(location_id: 3, limit: 25, limit_banamex: 5, title: "POSTRES LIGEROS", speaker_id: 22, category_id: 2, day_id: 2, length: 3, time: "12:30 - 14:00", slot: 6)
Workshop.create(location_id: 3, limit: 25, limit_banamex: 5, title: "TBD", speaker_id: 18, category_id: 2, day_id: 3, length: 2, time: "09:00 - 11:00", slot: 10)
...
Workshop.create(location_id: 5, limit: 15, limit_banamex: 5, title: "LA MUJER EN EL MUNDO, LOGROS Y RETOS", speaker_id: 52, category_id: 6, day_id: 2, length: 1, time: "13:00 - 14:00", slot: 10, description: "Raquel nos compartirá su experiencia de vida como mujer exitosa y reconocida, cómo percibe la sociedad a la mujer y cómo empoderar nuestro potencial femenino. ")
...
Workshop.create(location_id: 5, limit: 15, limit_banamex: 5, title: "COMPLEJO DE CENICIENTA", speaker_id: 53, category_id: 6, day_id: 2, length: 1, time: "10:00 - 11:00", slot: 7, description: "Esta plática habla sobre el miedo de las mujeres a la independencia.")
...
Workshop.create(location_id: 5, limit: 15, limit_banamex: 5, title: "CÓMO SIENTO, COMO", speaker_id: 56, category_id: 6, day_id: 2, length: 1, time: "09:00 - 10:00", slot: 6, description: "Conocer, comprender y resolver la relación que hay en la manera en la que sentimos y la manera en la que comemos, para crear un estilo de vida saludable.")
...
Workshop.create(location_id: 5, limit: 15, limit_banamex: 5, title: "EL PODER DE LA MEDITACIÓN", speaker_id: 57, category_id: 6, day_id: 3, length: 3, time: "09:00 - 10:30", slot: 16)
Workshop.create(location_id: 5, limit: 15, limit_banamex: 5, title: "LA IMPORTANCIA DE SOLTAR", speaker_id: 57, category_id: 6, day_id: 3, length: 1, time: "10:30 - 11:30", slot: 17)
...
Workshop.create(location_id: 5, limit: 15, limit_banamex: 5, title: "LA ENERGÍA DE LA LUNA EN ASTROLOGÍA", speaker_id: 60, category_id: 6, day_id: 2, length: 3, time: "17:00 - 18:30", slot: 14, description: "En este taller Helena nos habla sobre la energía de la luna y sus aspectos generales.")
...
Workshop.create(location_id: 5, limit: 15, limit_banamex: 5, title: "LA FOTOGRAFIA Y SUS MEJORES REPRESENTANTES", speaker_id: 63, category_id: 6, day_id: 2, length: 3, time: "15:30 - 17:00", slot: 13, description: "En este taller Ana nos hablará de su experiencia como fotógrafa y nos compartirá algunos tips y bases de fotografía.")

Speaker.create(first_name: "MAYRA", last_name: "CONTRERAS", category_id: 7)
Workshop.create(location_id: 5, limit: 15, limit_banamex: 5, title: "NEGOCIOS Y MUJER, COMO GANAR LA VITRINA DIGITAL", speaker_id: 64, category_id: 6, day_id: 1, length: 1, time: "16:00 - 17:00", slot: 1)
...
Workshop.create(location_id: 2, limit: 25, limit_banamex: 5, title: "BLANK", speaker_id: 18, category_id: 4, day_id: 2, length: 1, time: "13:00 - 14:00", slot: 4)
Workshop.create(location_id: 2, limit: 25, limit_banamex: 5, title: "BLANK", speaker_id: 18, category_id: 4, day_id: 2, length: 1, time: "13:00 - 14:00", slot: 8)

Workshop.create(location_id: 2, limit: 25, limit_banamex: 5, title: "BLANK", speaker_id: 18, category_id: 6, day_id: 2, length: 1, time: "13:00 - 14:00", slot: 5)
Workshop.create(location_id: 2, limit: 25, limit_banamex: 5, title: "BLANK", speaker_id: 18, category_id: 6, day_id: 2, length: 4, time: "13:00 - 14:00", slot: 12)
